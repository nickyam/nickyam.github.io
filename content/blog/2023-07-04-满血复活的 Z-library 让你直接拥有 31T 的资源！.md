---
title: "满血复活的 Z-library 让你直接拥有 31T 的资源！"
date: 2023-07-04
tags:
  - "开源项目"
  - "教育"
categories: ["科技"]
slug: z-library-revived
...
2023 年初，Z-library 宣布回归。

看懂下文，你将拥有一座容量 **31T**，而且**永远不会下线**的电子图书馆。

### **一、Z-lib 官方项目**

先讲讲 Z-library 的官方渠道，毕竟它已经正式回归。

#### 1.1、Z-lib 主页

2023 年初，Z-library 宣布回归，但换了一种方式。

新版 Z-library 不再有统一的“**主页**”，取而代之的是“**登陆页**”，打开 [https://singlelogin.re](https://singlelogin.re/) 即可注册。（魔法）

![S21_Zlib](/images/remote/img_6f3b4772_4abe0fb8afeaaf6d73e09.png)

注册后，系统会自动分配两个“**专属域名**”给你，将它们保存起来，然后就可以用**注册时的密码**来登陆了。

注册默认是初级用户，**1 天可下载 10 次**，通过捐赠则可以成为高级用户。

![S21_Zlib](/images/remote/img_21f8d0d2_2f650dd94bec4dbbeac7b.png)

#### 1.2、Z-lib 手机端

Z-library 官方的安卓 APP 一直可用，目前最新版本为 1.07，但需要魔法才能访问。（仅支持安卓）

下载：<https://www.lanzouv.com/b07or2pgh>

#### 1.3、Z-lib 电报机器人

Z-library 的官方电报机器人分两种：一种是 **Premium bot**，一种是 **Basic bot**。（魔法）

**Premium bot：**

Premium bot 捐助过的用户才会拥有，绑定即可使用，地址： <https://t.me/zlibrary2bot>

在窗口里输入**书名、作者名、ISBN、ASIN** 即可返回下载地址。

每天最多可以下载 **60** 次。

![S21_Zlibbot](/images/remote/img_49ee100c_1fd9f9f724b62aa9f2b6c.jpg)
...
2、点击 <https://t.me/BotFather> 进入 TG。
...
![S21_Zlibbot_New](/images/remote/img_5c29808b_dfbbae3c7e3176d2580a0.jpg)

6、保存生成的 **Token**，并粘贴到之前的网页里即可完成绑定。

![S21_Zlibbot_New2](/images/remote/img_6dc36fcd_f0d03bd6604847900aa19.jpg)

**桌面端 TG ：**

桌面版 Telegram 如果因收不到验证码而无法登录，可以使用 **Telegram Lite** 版本。
...
下载 [TOR 浏览器](https://www.torproject.org/zh-CN/download)（需魔法），然后打开下面任意一个网页地址即可。

地址 1：[http://loginzlib2vrak5zzpcocc3ouizykn6k5qecgj2tzlnab5wcbqhembyd.onion](http://zh.loginzlib2vrak5zzpcocc3ouizykn6k5qecgj2tzlnab5wcbqhembyd.onion/)

地址 2：[http://zlibrary24tuxziyiyfr7zd46ytefdqbqd2axkmxm4o5374ptpc52fad.onion](http://zlibrary24tuxziyiyfr7zd46ytefdqbqd2axkmxm4o5374ptpc52fad.onion/)
...
[https://zlibrary.cf](https://zlibrary.cf/)（可搜索论文）

![S21_ZlibAPP](/images/remote/img_7557d731_cb9e3d1a7de44a4acad3a.png)

这些网站的最大特点，就是**国内网络也能直接访问**。

而下载时，它会先调用官方接口，然后再走 **Zlib App** 的下载线路，而且由于是**公共账号**，所以下载也没有限制。

![S21_ZlibAPP](/images/remote/img_c3dbbcda_229fea3f8256b27437c9f.png)
...
![S21_Anna](/images/remote/img_8b5f215b_0a63483e05c99974a8173.png)
...
![S21_Anna2](/images/remote/img_11eafbea_545bb1cedc1b1b1fdcddf.png)
...
![S21_Anna3](/images/remote/img_a467df70_647baea4a144c43f9293b.png)
...
![S21_BookSearcher](/images/remote/img_65c58ce7_0aa5cce12516291b8bf53.png)
...
地址：<https://github.com/book-searcher-org/book-searcher>

![S21_BookSearcher3](/images/remote/img_a6eea71d_0140143e834731d6df628.png)
...
![S21_BookSearcher2](/images/remote/img_958f2bae_f97ca209937c18c1ab659.png)
...
地址：<https://github.com/tw93/Pake/releases>

![S21_Zlibbot_Desktop](/images/remote/img_c171bc15_64101b5f9e3dfa597602a.png)
...
![S21_BookSearcher4](/images/remote/img_042b30b3_d5baa1c93792cb17bf8cb.png)
...
地址：[https://search.yibook.org](https://search.yibook.org/)

![S21_ZhelperSearch](/images/remote/img_57dc5e5f_4c455198c52d9c0d05b67.png)
...
如果什么时候，又发生了不可预料的事件。大家还可以去关注这两个地方，可能会有惊喜哦！

- Wikipedia：  
  <https://en.wikipedia.org/wiki/Z-Library>
- Reddit：  
  [https://www.reddit.com/r/zlibrary](https://en.wikipedia.org/wiki/Z-Library)
...
| Ylibrary | Zlibrary 书库 + 超星书库，是目前最好的中文电子书搜索引擎 |
